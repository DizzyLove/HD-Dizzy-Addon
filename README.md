...
- Pistol (Using the legendary two ROTT pistol sounds in a randomized way), using the ROTT pistol sprites I edited.
...
- Implemented addons made by the community : Karla's Imp Translations; Ace's Smug Hoe female avatar.
- New "secret revealed" sound effect.
- The Revolver is purple & gold now with matching ironsight.💜

-> Inside the -Optional addons- folder :
- HD_ROTT_PISTOL.pk3 [Standalone addons that needs to be loaded separately to use as a pistol replacement]
...
- Dizzy Color.pk3 for an alternate imp type coloring. Yellow is regular, Red is the mage and the Green one is healer.
